...
- [GET  /api/v1/agency/clients/<id>/jobs/](endpoints/agency.md) — List active jobs for a single client (authenticated)
- [GET  /api/v1/agency/clients/<id>/activities/](endpoints/agency.md) — List activities for a single client (authenticated)
- [GET  /api/v1/agency/clients/<id>/notes/](endpoints/agency.md) — List notes for a single client (authenticated)
- [POST /api/v1/agency/clients/<id>/notes/](endpoints/agency.md) — Create a new note for a single client (authenticated)
