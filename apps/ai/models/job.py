...
class JobDescriptionExtraction(BaseModel):
    """
    Schema for OpenAI JSON structured output extraction.
    Explicitly excludes raw_text to prevent token-exhaustion runaway streaming.
    """
...
class JobDescription(JobDescriptionExtraction):
    """
    Parsed job description with optional local raw_text attached.
    """
